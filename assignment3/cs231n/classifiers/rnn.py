...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # (2) embedding_in: NxTxW, captions_in: NxT, W_embed: VxW
        embedding_in, cache_embedding = word_embedding_forward(captions_in, W_embed)
        ...
        loss, dout = temporal_softmax_loss(out_temp_affine, captions_out, mask, verbose=False)
