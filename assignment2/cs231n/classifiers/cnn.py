...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        W2 = np.random.normal(0.0, weight_scale, (num_filters*pool_h*pool_w, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        loss, dsf = softmax_loss(out_3, y)
        
        dout_3, dW3, db3 = affine_backward(dsf, cache_3)
        dW3 += self.reg * W3

        dout_2, dW2, db2 = affine_relu_backward(dout_3, cache_2)
        dW2 += self.reg * W2
        
        _, dW1, db1 = conv_relu_pool_backward(dout_2, cache_1)
        dW1 += self.reg * W1
